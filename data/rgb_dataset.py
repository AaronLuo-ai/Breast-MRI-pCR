...
def get_pcr_label(raw_label, patient_id):
    ...
    exclusions = ["M83641802_20231010175132", "M44963301_20221129183544", "M46018541_20210421154917"]
...
class RGBConcatDataset(Dataset):
    ...
    def __init__(self, feature_path, response_path, model_config_path, checkpoint_path, transform=None):
        ...
        self.response_data = pd.read_excel(response_path, keep_default_na=False)
